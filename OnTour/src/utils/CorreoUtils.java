...
public class CorreoUtils {
    ...
    public static void enviarCorreoValidarDepositoApoderado(Apoderado apoderado, Deposito deposito) {

        String subject = "Depósito Registrado con éxito";
        String from = "registro@ontour.cl";
        String to = apoderado.getCorreo();
        String text = "<html><h2>Estimad@: " + apoderado.getNombres() + " " + apoderado.getaPaterno() + "<h2><br>"
                + "<h2>Su depósito ha sido registrado con éxito </h2><br>"
                + "Monto depósitado : <b>" + deposito.getMontoDeposito() + "</b><br><br><br>"
                + "Atte,<br> <b>Agencia OnTour.<b>" + "</html>";
